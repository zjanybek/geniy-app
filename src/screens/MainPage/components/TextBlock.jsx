...
const textItems = [
  'Каким мы видим этот мир? Мы считаем, что каждый человек гениален по своей природе. Мы вдохновляем друг друга на поиск',
  ' новых решений. Мы стремимся к совершенству. Присоединившись к нашей платформе, вы станете частью',
  // 'Мы стремимся к совершенству.',
  ' новой культуры общения и бизнеса, где этика, устремленность и профессионализм превыше всего. Мы',
  ' создаем не просто проекты, а творим истории и реализуем мечты.'
]
