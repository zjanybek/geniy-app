...
const ModalSendMessage = () => {
  return (
    <div className='pl-[51px] pr-[64px]'>
      ...
      <div className='mb-9'>
        <label className='mb-2 block text-17 tracking-[-0.17px] text-fontBlack'>
          Сообщение
        </label>
        <textarea
          name=''
          ...
          cols='30'
          rows='10'
          placeholder='Начните ваше общение с исполнителем. Уточните интересующие вас детали, обсудите сроки и бюджет. Помните, что ясное и дружелюбное общение - ключ к успешному сотрудничеству.'
          className='w-full rounded-[10px] border border-[#AEAEB2] px-5 py-[15px] text-15 leading-[1.33] tracking-[-0.15px] placeholder:text-[#AEAEB2]'
        ></textarea>
        <p className='mt-[13px] text-13 leading-[1.53] tracking-[-0.13px] text-[#8E8E93]'>
          0 / 3000 символов
        </p>
      </div>
      <div>
        ...
        <p className='mb-5 text-15 leading-[1.33] tracking-[-0.15px] text-fontDarkGrey'>
